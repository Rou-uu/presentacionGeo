...
@app.function
# -*- coding: utf-8 -*-
# paper_slide — Reducción del Teorema 2.2 (Figuras 3 y 4 del paper)
#
# Coordenadas extraídas de geogebra.xml, mapeadas a Manim.
#
# Topología:
#   Gráfica cúbica original: 2 nodos (grado 3) + 4 endpoints (grado 1)
#     Nodo izquierdo L → node vertices: D, E, H
#     Nodo derecho   R → node vertices: F, G, P
#
#   5 aristas → 5 túneles:
#     Central   L↔R:  paredes A-D/A-G (sup), E-B/B-F (inf); arc vtx A,B
#     Sup-izq   L↔TL: paredes D-C, C-O / H-N; arc vtx C
#     Inf-izq   L↔BL: paredes H-I-J-K / E-L-M; arc vtx I, L
#     Sup-der   R↔TR: paredes G-W-Z / P-Q-R; arc vtx W, Q
#     Inf-der   R↔BR: paredes P-S-T / F-U-V; arc vtx S, U
#
#   Diagonales forzadas (sólidas): g1:A-B, p1:H-C, n1:J-L, q1:W-Q, r1:S-U
#   Otras diagonales (punteadas): h1:A-I, i1:I-B, j1:A-P, k1:B-P,
#       s1:I-C, t1:I-L, a1:I-E, b1:I-D, l1:F-P, m1:G-P, c1:W-P, d1:P-U
...
def _():
    ...
    _slide_fns = [title_slide, holes_slide, paper_slide, example_paper]
